  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="flex-1">
        <section className="border-b border-eco-emerald-100 bg-gradient-to-b from-eco-emerald-100/60 via-eco-emerald-50 to-eco-emerald-50 px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-10">
              <div className="mx-auto max-w-3xl text-center lg:mx-0 lg:text-left">
                <p className="mb-3 inline-flex rounded-full border border-eco-emerald-200 bg-white/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-eco-emerald-700 shadow-sm sm:mb-4 sm:px-4 sm:text-xs">
                  Educacion ambiental
                </p>
                <h1 className="text-balance text-2xl font-extrabold tracking-tight text-eco-emerald-950 sm:text-3xl md:text-4xl lg:text-5xl">
                  Gamifica el reciclaje y convierte cada clase en una mision sostenible
                </h1>
                <p className="mt-4 text-pretty text-sm leading-relaxed text-eco-emerald-800 sm:mt-6 sm:text-base lg:text-lg">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-eco-emerald-200 bg-white/80 shadow-lg sm:rounded-3xl">
        ...
        >
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-xl font-bold text-eco-emerald-900 sm:text-2xl lg:text-3xl">
                ¿Por qué importa el reciclaje?
              </h2>
              <p className="mt-3 text-sm text-pretty text-eco-emerald-800 sm:mt-4 sm:text-base">
            ...
            <div className="mt-8 overflow-hidden rounded-2xl border border-eco-emerald-200 bg-eco-emerald-50/70 shadow-sm sm:mt-10 sm:rounded-3xl">
            ...
            <ul className="mt-8 grid gap-4 sm:mt-12 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
              {[
                ...
                <li
                  key={card.title}
                  className="flex flex-col rounded-2xl border border-eco-emerald-100 bg-white p-5 shadow-sm ring-1 ring-eco-emerald-100/60 sm:rounded-3xl sm:p-6"
                >
                  <span
                  ...
                  <h3 className="text-base font-semibold text-eco-emerald-900 sm:text-lg">{card.title}</h3>
                  <p className="mt-2 flex-1 text-xs leading-relaxed text-eco-emerald-700 sm:mt-3 sm:text-sm">
                    {card.body}
                  </p>
                </li>
              ))}
        ...
        <section
          id="separacion"
          className="scroll-mt-20 border-t border-eco-emerald-100 bg-white/70 px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16"
        >
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-6 lg:grid-cols-2 lg:items-center lg:gap-14">
              <div className="rounded-2xl border border-eco-emerald-200 bg-gradient-to-br from-eco-emerald-100 to-eco-lime-100 p-6 shadow-inner sm:rounded-3xl sm:p-8 lg:p-10">
                <h2 className="text-xl font-bold text-eco-emerald-900 sm:text-2xl lg:text-3xl">
                  Separación en origen
                </h2>
                <p className="mt-3 text-sm text-eco-emerald-800 sm:mt-4 sm:text-base">
              ...
              <div className="space-y-5 rounded-2xl border border-eco-emerald-100 bg-eco-emerald-50/50 p-5 sm:space-y-6 sm:rounded-3xl sm:p-8 lg:p-10">
                <div className="overflow-hidden rounded-xl border border-eco-emerald-200 bg-white/80 sm:rounded-2xl">
                ...
                <h3 className="text-base font-semibold text-eco-emerald-900 sm:text-lg">Tips rápidos</h3>
                <ul className="space-y-3 text-sm text-eco-emerald-800 sm:space-y-4">
                  <li className="flex gap-3 rounded-xl bg-white/80 p-3 shadow-sm sm:rounded-2xl sm:p-4">
      ...
      <footer className="mt-auto border-t border-eco-emerald-200 bg-eco-emerald-100/40 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 text-center text-xs text-eco-emerald-800 sm:flex-row sm:text-left sm:text-sm">
          <p>© {new Date().getFullYear()} EcoURP. Plataforma educativa de reciclaje.</p>
          <FooterAccessLink />
        </div>
        <div className="mx-auto mt-3 flex max-w-6xl flex-wrap items-center justify-center gap-4 text-xs text-eco-emerald-900 sm:mt-4 sm:gap-6 sm:text-sm">
          <a
            className="inline-flex items-center gap-1.5 underline decoration-eco-emerald-400 underline-offset-4 transition hover:text-eco-emerald-700 sm:gap-2"
